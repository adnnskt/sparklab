...
const PYSPARK_METHODS = new Set(['show','read','csv','json','parquet','option','options','format','load','save','write','display','groupBy','filter','where','printSchema','select','dropna','removeNulls','clear','isna','withColumn','drop','distinct','count','sort','orderBy','limit','head','first','take','collect','toPandas','rdd','dtypes','columns','join','agg','createDataFrame','toDF','createOrReplaceTempView','describe','summary']);
